      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            @endif
            @endforeach
              <img src="{{ asset('assets/img/qr.png')}}" class="card-img-top p-3" alt="">
            <!-- @if( Auth::user()->role == 1 )
            <li class="menu-item">
            ...
            <li class="menu-item">
              <a href="/nilai" class="menu-link">
                ...
                <div data-i18n="Account Settings">Nilai</div>
              </a>
            </li>
            @if( Auth::user()->role == 1 )
            <li class="menu-item">
            ...
            <li class="menu-item">
              <a href="/kriteria" class="menu-link">
                ...
                <div data-i18n="Account Settings">Kriteria</div>
              </a>
            </li>
            {{-- <li class="menu-item">
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            ...
                            @endphp
                            <small class="text-muted">{{ $roles[Auth::user()->role] }}</small>
                          </div>
                        </div>
                      </a>
                    </li>
                    ...
                    <li>
                      <a class="dropdown-item" href="auth-login-basic.html" class="nav-link" href="{{ route('logout') }}"
